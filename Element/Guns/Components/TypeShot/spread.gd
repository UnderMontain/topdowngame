...
func use_type_shot(_bullet_scene:BulletLogic, _direction:Vector2, _global_position:Vector2):
	...
	#var base_direction = (node.get_global_mouse_global_position() - node.position).normalized()
